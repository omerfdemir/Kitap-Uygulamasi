...
public class DatabaseHelper extends android.database.sqlite.SQLiteOpenHelper {
     ...
     public void createDataBase() throws IOException {
       ...
       boolean dbExist = checkDataBase();
        ...
        if(dbExist){
            ...
            //Veritabaný daha önce hiç oluþturulmamýþ o yüzden veritabanýný kopyala
    ...
    * kopyalayacak metod*/
    ...
    //  Veritabanýný uygulamada kullanacaðýmýz zaman açmak için gerekli metod
    ...
    //Veritabanýný iþimiz bittiðinde kapatmak için kullanacaðýmýz metod
